...
import './style.css'
import Groupe1 from "../assets/JUNGLE/Groupe1.png"
import Groupe2 from "../assets/JUNGLE/Groupe2.png"
        ...
        <div className="flex flex-col mt-28 w-full">
            ...
            <div className="flex justify-center items-center gap-4 flex-wrap my-10">
                <div className="flex flex-col justify-center items-center gap-2">
                    <img className="w-52 rounded-xl" src={Groupe1} alt="Cards projects" />
            ...
            <div className="flex justify-center items-center">
                <h2 className="font-bold text-3xl my-10 text-yellow-500">THE ZEFARIS</h2>
            </div>
